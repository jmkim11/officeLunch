...
완성된 코드뿐 아니라 판단 과정과 검증 결과를 함께 남깁니다.

- Issue: 문제, 범위, 완료 조건
- Pull Request: 구현 의도, 트레이드오프, 테스트 결과
- Test: 핵심 도메인 규칙과 실패 시나리오
- Decision Record: 중요한 기술 선택과 대안
- Operations: 배포, 로그, 모니터링, 장애 및 성능 개선 기록
- Retrospective: 실패, 원인, 학습, 다음 행동

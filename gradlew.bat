...
@rem Keep wrapper and test-worker caches local to the project by default.
@rem This avoids failures caused by locked or corrupted user-level Gradle caches.
